...
class Resultados extends Component
{
    ...
    public function render()
    {
        ...
        $categorias    = ResultadoScraping::select('categoria')->distinct()->whereNotNull('categoria')->orderBy('categoria')->pluck('categoria');

        return view('livewire.scraper.resultados', compact('resultados', 'paises', 'categorias'));
    }
}
