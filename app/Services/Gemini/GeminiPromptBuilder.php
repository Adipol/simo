...
A) `personas_detectadas`: array con TODAS las personas cuyo nombre aparece escrito en el diff (en líneas + o -, no inferidas). Listá a TODOS los nombres que veas, sin importar si "entraron" o "salieron". Ej: si el diff tiene 2 líneas con `-` que mencionan a Bukovic y Rodriguez, ambos van acá.
...
3. Si SÍ hay personas:
   ...
   e. Evaluá riesgo AML: alto (MAE o cargo clave), medio (gerencia), bajo (técnico/administrativo)
...
- "+ Proveedores de Software" → Encabezado de sección, no es persona → personas_detectadas=[], persona_nueva=null
- "- _Transparencia\n+ Transparencia" → Cambio de formato → personas_detectadas=[]
- "+ RESOLUCIÓN AETN Nº 180/2026\n+ AETN Y MINISTERIO DE SALUD COORDINAN ACCIONES CONTRA EL DENGUE" → Titular institucional sin nombre de persona
