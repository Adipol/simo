...
class DedupeArticulosServiceTest extends TestCase
{
    ...
    public function test_new_article_becomes_secondary_when_candidate_matches(): void
    {
        ...
        //
        // Titles must be NEARLY IDENTICAL — pg_trgm similarity must clear the configured
        // 0.90 threshold. Single-character diff is the most realistic prod scenario
        // (typo, plural/singular variation, accent normalization).
        ...
        // Identical title with one trailing punctuation change — guarantees sim ≈ 0.99
        $new = $this->makeArticle('Renuncia del gerente Carlos Cronenbold de YPFB Bolivia hoy!', [
